      ...
      <Card className="bg-card border-border p-6 space-y-5">
        ...
        <div className="p-4 rounded-lg bg-accent/30 border border-border flex items-start gap-3">
          ...
          <div className="text-xs text-muted-foreground">
            ...
            <p>For production use, API keys should be stored as environment variables in the dashboard settings. This form stores them on your user profile for quick setup.</p>
          </div>
        </div>
        ...
        <Button onClick={handleSave} className="w-full bg-primary text-primary-foreground hover:bg-primary/90 h-11">
